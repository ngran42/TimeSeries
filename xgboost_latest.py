...
# MAGIC %md
# MAGIC source code:https://medium.com/mlearning-ai/forecast-with-xgboost-a1abf870c1cc#:~:text=In%20Python%2C%20the%20XGBoost%20library%20gives%20you%20a,2D%20sparse%20arrays%2C%20cuDF%20DataFrames%20and%20Pandas%20DataFrames.
...
def xgboost_forecast(X_train, X_test):
	...
	yhat = model.predict(asarray([X_test]))
	return yhat[0]
